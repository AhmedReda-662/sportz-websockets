...
CREATE UNIQUE INDEX "commentary_match_sequence_uidx" ON "commentary" USING btree ("match_id","sequence");--> statement-breakpoint
CREATE INDEX "commentary_match_event_idx" ON "commentary" USING btree ("match_id","event_type");--> statement-breakpoint
